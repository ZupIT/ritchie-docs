...
![Example of how to add the commons repository commands to Ritchie](/docs-ritchie/rit-add-repo-min.gif)
...
![Example of how to remove the commons repository commands from Ritchie](/docs-ritchie/rit-delete-repo-min.gif)
