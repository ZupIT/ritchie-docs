...
O tutorial configura os parâmetros de entrada dentro do arquivo config.json, mas executar a fórmula sem informá-los usando prompt ou stdin (serão extraídos automaticamente). Você encontrará todas as informações necessárias na seção de [**configurar inputs**](/pt-br/fórmulas/arquivo-config/).
...
👉 Se você completou o segundo tutorial, vá para o terceiro [**Como usar os inputs condicionais?**](/pt-br/tutoriais/usar-inputs-condicionais/)!
