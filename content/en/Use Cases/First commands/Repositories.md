...
![Example of how to add the commons repository commands to Ritchie](/shared/rit-add-repo-min.gif)
...
![Example of how to remove the commons repository commands from Ritchie](/shared/rit-delete-repo-min.gif)
