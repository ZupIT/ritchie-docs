...
When [**implementing a formula**](/formulas/configure-inputs/), the file where the operation is coded needs to execute a command line associated to a formula.‌
...
​👉 Check out the [**tutorials**](/tutorials/) page to apply all Ritchie's concepts you have learned.‌
